...
<body>
  <!-- Navigasi -->
  <nav class="bg-sky-800 text-white flex flex-row items-center flex-nowrap gap-5 p-3 ">
    <a href="#"><img src="/Asset/Logo Tripnesia.png" alt="Logo Tripnesia" class=" h-8"></a>
    <div class="bg-amber-300 rounded-full items-center flex-grow-[3]">
      <input 
      type="text"
      placeholder="Search " 
    ...
    <ul class="hidden md:flex flex-grow justify-center gap-4">
    <a href="#" class="flex-grow-[1]">Menu</a>
    <a href="#" class="flex-grow-[1]">Menu</a>
    <a href="#" class="flex-grow-[1]">Menu</a>
    <a href="#" class="flex-grow-[1]">Menu</a>
    </ul>
