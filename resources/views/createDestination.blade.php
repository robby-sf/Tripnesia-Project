...
<body class="font-inter">
    <form action="{{ route('store') }}" method="POST" enctype="multipart/form-data"
        class="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-md space-y-6">
        @csrf
        ...
        <div>
            ...
            <input type="text" id="nama" name="nama"
                class="mt-1 w-full p-2 rounded-sm border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 border-1"
                required>
        </div>
        ...
        <div>
            ...
            <input type="file" id="gambar" name="gambar" accept="image/*"
                class="mt-1 w-full text-sm text-gray-600 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100">
        </div>
        ...
        <div>
            ...
            <textarea id="alamat" name="alamat" rows="2"
                class="mt-1 w-full p-2 rounded-sm border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 border-1"></textarea>
        </div>
