...
<head>
    ...
    <title>{{ $title ?? 'Edit Paket' }} - Tripnesia</title>
                ...
                <form action="{{ route('admin.package.update', $package->id) }}" method="POST"
                    ...
                    <div class="bg-white shadow-md rounded-lg overflow-hidden">
                        ...
                        <div class="border-b border-gray-200 px-6 py-4">
                            <h3 class="text-lg font-semibold text-gray-800">Formulir Edit Paket</h3>
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" name="tickets" id="tickets"
                                        value="{{ old('tickets', $package->tickets) }}"
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <img src="{{ asset('storage/' . $package->image) }}" alt="{{ $package->name }}"
                                        class="h-24 w-auto rounded-md my-2 border border-gray-200 p-1">
                                    <input type="file" name="image" id="image"
                                        class="mt-2 block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-gray-100 file:text-gray-700 hover:file:bg-gray-200">
                                    <p class="text-xs text-gray-500 mt-1">Kosongkan jika tidak ingin mengubah gambar.
                                    </p>
                                    @error('image')
                                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                                    @enderror
