        ...
        <main class="flex-1 p-6 md:p-8 bg-gray-50">
            <header class="flex justify-between items-center w-full mb-8">
                <div>
                    ...
                    <p class="text-sm text-gray-500">Lihat dan kelola detail pesanan di bawah ini.</p>
                </div>
                <a href="{{ route('admin.pesanan.index') }}"
                    class="flex items-center text-sm bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg shadow-sm">
                                ...
                                <div class="border-t pt-4 text-right">
                                    <button type="submit" :disabled="!selectedStatus"
                                        x-on:click="
                                            ...
                                            "
                                        class="inline-flex items-center text-sm bg-white hover:bg-gray-100 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg shadow-sm disabled:opacity-50 disabled:cursor-not-allowed">
                                        Simpan Perubahan
                                    </button>
                                </div>
                            </div>
