<aside class="w-64 shrink-0 bg-[#0f172a] text-gray-300 flex flex-col min-h-screen justify-between">
    ...
    <div>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            <a href="/admin" class="flex items-center px-4 py-2.5 text-sm font-medium rounded-lg hover:bg-[#1e293b] hover:text-white {{ request()->is('admin') ? 'bg-[#1e293b] text-white' : '' }}">
                <!-- Ikon Dashboard -->
